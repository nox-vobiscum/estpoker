/* room.js — externalized room logic (no inline JS required) */

(() => {
  // Pick name/room from the script tag's data-attrs (fallbacks for safety)
  ...
  // i18n fallbacks (Thymeleaf already put visible labels into DOM)
  const TXT_AVG = 'Avg:';
